        ...
        <div class="container-fluid">
			<table class="table table-hover table-strip">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * FROM `blog_posts` ORDER BY `created_at` DESC");
					...
					?>
						<tr>
							...
							<td><p class="m-0 truncate"><?php echo $row['content'] ?></p></td>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this blog post permanently?","delete_blog",[$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [
