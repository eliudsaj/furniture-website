...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `blog_posts` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Blog Post</h3>
	</div>
	<div class="card-body">
		<form action="" id="blog-form">
			...
			<div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control rounded-0" required value="<?php echo isset($title) ?$title : '' ?>" />
			</div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="author" id="author" class="form-control rounded-0" required value="<?php echo isset($author) ?$author : '' ?>" />
			</div>
            <div class="form-group">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=blog">Cancel</a>
	</div>
</div>
<script>
